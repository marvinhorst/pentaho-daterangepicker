...
jQuery.fn.daterangepicker = function(settings){
	...
	var options = jQuery.extend({
		presetRanges: [
			...
			{text: 'Last 365 days', dateStart: '1 year ago', dateEnd: 'today' },
    ...
    jQuery.each(options.topsets, function(key, value) {
      jQuery('<li class="ui-daterangepicker-'+ key +' ui-corner-all"><span class="ui-icon ui-icon-triangle-1-e"></span><a href="#">'+ value +'</a></li>')
      .appendTo(ul);
    });
